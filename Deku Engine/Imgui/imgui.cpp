...
ImGuiStyle::ImGuiStyle()
{
	...
	Colors[ImGuiCol_WindowBg]				= ImVec4(0.25f, 0.25f, 0.25f, 0.95f);	// Windows Background
	Colors[ImGuiCol_ChildWindowBg]			= ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	Colors[ImGuiCol_PopupBg]				= ImVec4(0.25f, 0.25f, 0.25f, 0.90f);
	Colors[ImGuiCol_Border]					= ImVec4(0.10f, 0.10f, 0.10f, 1.00f);	// ImVec4(0.70f, 0.70f, 0.70f, 0.65f)
	Colors[ImGuiCol_BorderShadow]			= ImVec4(0.10f, 0.10f, 0.10f, 0.90f);
	Colors[ImGuiCol_FrameBg]				= ImVec4(0.10f, 0.10f, 0.10f, 0.50f);   // Background of checkbox, radio button, plot, slider, text input
	Colors[ImGuiCol_FrameBgHovered]			= ImVec4(0.25f, 0.88f, 0.81f, 0.20f);
	Colors[ImGuiCol_FrameBgActive]			= ImVec4(0.25f, 0.88f, 0.81f, 0.50f);
	Colors[ImGuiCol_TitleBg]				= ImVec4(0.10f, 0.10f, 0.10f, 1.00f);
	Colors[ImGuiCol_TitleBgCollapsed]		= ImVec4(0.10f, 0.10f, 0.10f, 1.00f);
	Colors[ImGuiCol_TitleBgActive]			= ImVec4(0.10f, 0.10f, 0.10f, 1.00f);
	Colors[ImGuiCol_MenuBarBg]				= ImVec4(0.25f, 0.25f, 0.25f, 0.90f);
	Colors[ImGuiCol_ScrollbarBg]			= ImVec4(0.10f, 0.10f, 0.10f, 0.90f);
	Colors[ImGuiCol_ScrollbarGrab]			= ImVec4(0.30f, 0.30f, 0.30f, 0.90f);
	Colors[ImGuiCol_ScrollbarGrabHovered]	= ImVec4(0.40f, 0.40f, 0.40f, 0.90f);
	Colors[ImGuiCol_ScrollbarGrabActive]	= ImVec4(0.50f, 0.50f, 0.50f, 0.90f);
	...
	Colors[ImGuiCol_CloseButton]			= ImVec4(0.30f, 0.30f, 0.30f, 0.90f);
	Colors[ImGuiCol_CloseButtonHovered]		= ImVec4(0.40f, 0.40f, 0.40f, 0.90f);
	Colors[ImGuiCol_CloseButtonActive]		= ImVec4(0.50f, 0.50f, 0.50f, 0.90f);
	Colors[ImGuiCol_PlotLines]				= ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
	Colors[ImGuiCol_PlotLinesHovered]		= ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
	Colors[ImGuiCol_PlotHistogram]			= ImVec4(0.25f, 0.88f, 0.81f, 0.50f);
	Colors[ImGuiCol_PlotHistogramHovered]	= ImVec4(0.90f, 0.90f, 0.90f, 0.80f);
	Colors[ImGuiCol_TextSelectedBg]			= ImVec4(0.25f, 0.88f, 0.81f, 0.60f);
